...
export const alt = "Student Portal | Shikshak";
export const size = {
  width: 1200,
  height: 630,
};
    ...
    (
      <div
        style={{
          ...
          display: "flex",
          flexDirection: "row",
          backgroundColor: "#F0F9FF", // Sky 50 base
      ...
      >
        ...
        >
          ...
          >
             <div style={{ width: 40, height: 4, background: "#0284C7", marginRight: 15, display: 'flex' }}></div>
             Student Portal
          </div>
          <div
            style={{
          ...
          >
            <span>Access your courses, track progress,</span>
            <span>and achieve your goals.</span>
          </div>
        </div>
