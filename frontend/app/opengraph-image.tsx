...
export const alt = "Shikshak - Revolutionizing Education";
export const size = {
  width: 1200,
  height: 630,
};
    ...
    (
      <div
        style={{
          ...
          display: "flex",
          flexDirection: "row",
          backgroundColor: "#EEF2FF", // Indigo 50 base
      ...
      >
        ...
        >
          ...
          >
             <div style={{ width: 40, height: 4, background: "#4F46E5", marginRight: 15, display: 'flex' }}></div>
             Platform
          </div>
          <div
            style={{
          ...
          >
            <span>Empowering minds with cutting-edge</span>
