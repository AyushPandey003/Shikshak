        ...
        <div className="mb-6">
            <div className="border-b border-gray-200 flex items-center gap-6 sm:gap-8 text-sm font-bold text-gray-600 mb-6 overflow-x-auto scrollbar-hide pb-1">
                <button
                    ...
                    className={`pb-3 border-b-2 transition-colors whitespace-nowrap ${activeTab === 'description' ? 'border-[#FF6B6B] text-[#FF6B6B]' : 'border-transparent hover:text-gray-900'}`}
                >
                    Description
                </button>
                <button
                    onClick={() => setActiveTab('transcript')}
                    className={`pb-3 border-b-2 transition-colors whitespace-nowrap ${activeTab === 'transcript' ? 'border-[#FF6B6B] text-[#FF6B6B]' : 'border-transparent hover:text-gray-900'}`}
                >
                    Transcript
                </button>
                <button
                    onClick={() => setActiveTab('notes')}
                    className={`pb-3 border-b-2 transition-colors whitespace-nowrap ${activeTab === 'notes' ? 'border-[#FF6B6B] text-[#FF6B6B]' : 'border-transparent hover:text-gray-900'}`}
                >
                    Notes
                </button>
                <button
                    onClick={() => setActiveTab('downloads')}
                    className={`pb-3 border-b-2 transition-colors whitespace-nowrap ${activeTab === 'downloads' ? 'border-[#FF6B6B] text-[#FF6B6B]' : 'border-transparent hover:text-gray-900'}`}
                >
                    Downloads
                </button>
            </div>
            ...
            <div className="min-h-[200px] text-gray-700 leading-relaxed text-[15px]">
                {activeTab === 'description' && (
                    <div className="prose prose-red prose-lg max-w-none text-gray-600">
                ...
                {activeTab === 'transcript' && (
                    <div className="space-y-4">
                        <div className="flex gap-4">
                            <span className="text-xs text-[#FF6B6B] font-bold min-w-[30px] pt-1">0:00</span>
                        ...
                        <div className="flex gap-4">
                            <span className="text-xs text-[#FF6B6B] font-bold min-w-[30px] pt-1">0:30</span>
                        ...
                        <div className="flex gap-4">
                            <span className="text-xs text-[#FF6B6B] font-bold min-w-[30px] pt-1">1:15</span>
